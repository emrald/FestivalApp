...
import model.SlideMenuItem;
import util.ViewAnimator;
...
public class MainActivity extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
      ...
      /* SupportAnimator animator = ViewAnimationUtils.createCircularReveal(view, 0, topPosition, 0, finalRadius);
        ...
        animator.start();*/
        ContentFragment contentFragment = new ActivityMyOrders();//ContentFragment.newInstance(this.res);
...
/*  Uri mUri = mIntent.getParcelableExtra(Intent.EXTRA_STREAM);
                ...
                Bitmap imgBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher);
